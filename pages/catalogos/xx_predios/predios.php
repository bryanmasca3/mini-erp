...
<!-- modal de Personas -->
<script src="pages/modals/Predios/mod.predio.js"></script>
      ...
      <div class="box box-primary">
        <div class="box-header no-padding">
          <div class="mailbox-controls">
            ...
            <div class="btn-group">
              <select id="cboDMisioneros" class="btn btn-default btn-sm" style="height:30px;" onchange="javascript:appGridAll();" title="Distritos Misioneros"></select>
            </div>
            <div class="btn-group">
...
<script src="pages/catalogos/predios/predios.js"></script>
<script>
